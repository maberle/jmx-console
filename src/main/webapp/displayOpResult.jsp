...
<table width="100%" cellspacing="0" cellpadding="0" border="0" align="center">
  <tr>
	...
	<td><img src="images/as7_logo.png" align="left" border="0" alt="JBoss"></td> 
	     
	<td height="105" align="center">
  		<h1>JMX MBean Operation View</h1><%= hostname %>
  	</td>
  	
	<td height="105" valign="middle">
		<h1>JMX MBean Operation Result <code><%= opResultInfo.name%>()</code></h1>
	</td>
    ...
    <p>
      ...
      <input type="button" value="Back to MBean" onClick="javascript:location='HtmlAdaptor?action=inspectMBean&amp;name=<%= URLEncoder.encode(request.getParameter("name")) %>'"/>
    </p>
    <p>
    <%
